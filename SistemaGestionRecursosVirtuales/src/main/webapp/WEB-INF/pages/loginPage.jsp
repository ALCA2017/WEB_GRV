						...
						<form role="form" name='f'
							...
							<div class="form-group">
								<input type="text" name="username" placeholder="Email..."
									class="form-control" id="form-username" value="vacpcanta@hotmail.com">
							</div>
							<div class="form-group">
								<input type="password" name="password"
									placeholder="Contraseña..." class="form-control"
									id="form-password" value="Admin240311">
							</div>
							<button name="submit" type="submit" class="mybtn">Ingresar</button>
						</form>
					</div>
				</div>
			</div>
