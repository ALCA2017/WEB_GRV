...
public class RecursoImagenVO implements Serializable{
    ...
    public RecursoImagenVO(Integer id_recurso_img, Integer id_sesion, String result, String text, String uRL,
    ...
    public String toString() {
        return "RecursoImagenVO [id_recurso_img=" + id_recurso_img + ", id_sesion=" 
